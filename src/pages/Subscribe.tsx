  ...
  return (
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      <div className="w-full max-w-[1100px] lg:flex lg:flex-row flex-col items-center justify-between mt-20 mx-auto ">
        <div className="max-w-[640px] flex flex-col items-center text-center  lg:p-0 p-4">
          <Logo />
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-green-500 py-5 uppercase mt-4 text-sm font-bold hover:bg-green-700 transition-colors disabled:opacity-50'"
            >
              garantir minha vaga
            </button>
          </form>
